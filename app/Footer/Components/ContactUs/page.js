      ...
      <div className='w-full p-6 bg-[#F7F7F7]'>
        ...
        <div className='max-w-5xl mx-auto'>
          ...
          <div className='bg-white p-4 shadow-md rounded-md mb-6 flex flex-col md:flex-row gap-4 hover:shadow-xl'>
            <img src='/Assets/Caller-person.jpg' alt='Booking Assistance' className='w-full md:w-1/3 rounded-md object-cover transform transition-transform duration-300 hover:-translate-y-1' />
          ...
          <div className='bg-white p-4 shadow-md rounded-md mb-6 flex flex-col md:flex-row gap-4 lg:flex-row-reverse hover:shadow-xl'>
            <img src='/Assets/Caller-assistant.webp' alt='Existing Booking Assistance' className='w-full md:w-1/3 rounded-md object-cover transform transition-transform duration-300 hover:-translate-y-1' />
            <div>
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          <section className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='w-auto mx-auto bg-white shadow-md rounded-md p-4 hover:shadow-xl'>
              <img src='/Assets/lost-items-icon.webp' alt='Lost and Found' className='w-full h-50 object-contain rounded-md mb-3' />
            ...
            <div className='w-auto mx-auto bg-white shadow-md rounded-md p-4 hover:shadow-xl'>
              <img src='/Assets/contact-us.jpg' alt='Contact Us' className='w-full h-50 object-contain rounded-md mb-3' />
