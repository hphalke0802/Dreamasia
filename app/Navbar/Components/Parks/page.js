  ...
  return (
    <div className='max-w-4xl mx-auto bg-white flex flex-col md:flex-row items-center justify-center gap-4 px-3'>
      ...
      <section onClick={() => {
        ...
        <img src={publicAsset('/Assets/tick-2.jpg')} alt='Amusement Park' className='w-full h-32 object-cover rounded-lg group-hover:opacity-90 transition' />
      ...
      <section onClick={() => {
        ...
        <img src={publicAsset('/Assets/big-banner-2.png')} alt='Water Park' className='w-full h-32 object-cover rounded-lg group-hover:opacity-90 transition' />
      ...
      <section className='text-center border-1 border-blue-200 rounded-xl p-2 bg-white'>
        <img src={publicAsset('/Assets/discover2.jpg')} alt='Fast Food' className='w-full h-30 rounded-lg' />
