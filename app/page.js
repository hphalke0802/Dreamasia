...
import BookingCircle from './Booking/BookingCircle/page';
...
const page = () => {
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      setShowVideo(true); // trigger video once
    }, 2000);
  ...
  // Handle video end just once 2nd video handler
  useEffect(() => {
  ...
  return (
    <div className="bg-[#F7F7F7]">
      ...
      <div className="w-full mt-18 md:mt-0">
        {/* Background Video */}
        <video
          src="/images/Dreamasia Horizontal.mp4"
          autoPlay
          muted
          loop
          playsInline
          className="w-full h-full lg:h-[79vh] object-cover"
        />
      </div>
      ...
      <div className="h-8 flex items-center justify-center gap-4 bg-[#f7bb23] border-y-4 border-yellow-600 font-semibold text-center py-4">
        <img
          src="/images/line.png"
          alt="decorative line"
          className="hidden md:block md:h-6 xl:h-10"
        />
      ...
      {/* Navigation Section */}
      <div className="relative px-4 mt-[12vh] sm:mt-[28vh] md:mt-[22vh] xl:mt-[24vh]"
>
        {/* Background Image */}
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[100%] md:-translate-y-[133%] xl:-translate-y-[100%] z-10 pointer-events-none"
        >
          <img
            src='/images/character1.png'
            className='w-full md:w-64 lg:w-90'
            alt='Character'
          />
        </motion.div>
        ...
        <div className="relative z-10 flex items-center justify-center bg-grident py-6 rounded-2xl mx-auto max-w-4xl transition-all duration-300">
          ...
          <div className="flex flex-col items-center gap-3 bg-gradient-to-t from-purple-100 to-purple-300 py-4 px-2 rounded-2xl shadow-xl group transition duration-300">
            <img src='/images/masti.jpg'
            className='rounded-xl'/>
            <button
              onClick={() => router.push("/Offers")}
              className="bg-gradient-to-tr from-white to-gray-100 border border-gray-300 text-black font-semibold px-4 py-2 rounded-full shadow-md hover:shadow-purple-600 hover:scale-105 transition-all duration-300 focus:outline-none cursor-pointer">
              Explore Offers!
            </button>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 p-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md w-72 transition hover:shadow-xl">
          <img src="/images/childs.jpeg" alt="Cool Kid" className="w-full h-28 object-cover rounded-md mb-3 transform transition-transform duration-300 hover:-translate-y-1" />
        ...
        {/* Awesome Adult Card */}
        <div className="bg-white p-4 rounded-lg shadow-md w-72 transition hover:shadow-xl">
          <img src="/images/adult .jpg" alt="Awesome Adult" className="w-full h-28 object-cover rounded-md mb-3 transform transition-transform duration-300 hover:-translate-y-1" />
        ...
        {/* Super Senior Card */}
        <div className="bg-white p-4 rounded-lg shadow-md w-72 transition hover:shadow-xl">
          <img src="/images/senior.jpg" alt="Super Senior" className="w-full h-28 object-cover rounded-md mb-3 transform transition-transform duration-300 hover:-translate-y-1" />
      ...
      <div className="bg-[#F9FAFB] py-10">
        ...
        <section className="max-w-5xl mx-auto flex flex-wrap justify-center gap-6 px-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden w-72 transition hover:shadow-xl">
            <img src="/images/facilities.jpg" alt="Water Park" className="w-full h-40 object-cover transform transition-transform duration-300 hover:-translate-y-1" />
          ...
          {/* Amusement Park */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden w-72 transition hover:shadow-xl">
            <img src="/images/slides.png" alt="Amusement Park" className="w-full h-40 object-cover transform transition-transform duration-300 hover:-translate-y-1" />
            <div className="p-4 text-center">
          ...
          {/* Destination Wedding */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden w-72 transition hover:shadow-xl">
            <img src="/images/destinationwedding.jpg" alt="Destination Wedding" className="w-full h-40 object-cover transform transition-transform duration-300 hover:-translate-y-1" />
            <div className="p-4 text-center">
      ...
      <div className="bg-[#F9FAFB] py-10 px-4">
        ...
        <section className="max-w-6xl mx-auto flex flex-wrap justify-center gap-5">
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg w-64 text-center hover:shadow-xl">
            <img src="/images/FlexibleBookings.jpg" alt="Flexible bookings" className="w-full h-32 object-cover rounded-md mb-3" />
          ...
          <div className="bg-white p-4 rounded-lg shadow-md w-64 text-center hover:shadow-xl">
            <img src="/images/BulkBooking.jpg" alt="Bulk Booking" className="w-full h-32 object-cover rounded-md mb-3" />
          ...
          {/* Zero booking fees */}
          <div className="bg-white p-4 rounded-lg shadow-md w-64 text-center hover:shadow-xl">
            <img src="/images/Zerobookingfees.jpg" alt="Zero Booking Fees" className="w-full h-32 object-cover rounded-md mb-3" />
          ...
          {/* Accomodation​ */}
          <div className="bg-white p-4 rounded-lg shadow-md w-64 text-center hover:shadow-xl">
            <img src="/images/Accomodation.jpg" alt="Accommodation" className="w-full h-32 object-cover rounded-md mb-3" />
